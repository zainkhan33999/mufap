...
export default function VisionMission() {
  return (
    ...
    <section className="relative bg-[#1A3B2D] py-20 px-6 md:px-20 lg:px-32 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-16">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-xl hover:scale-105 transition-transform"
          >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            >
              <CheckCircle className="text-green-300 w-6 h-6 mt-1 flex-shrink-0" />
